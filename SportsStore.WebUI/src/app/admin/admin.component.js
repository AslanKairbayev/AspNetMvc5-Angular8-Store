...
var AdminComponent = /** @class */ (function () {
    function AdminComponent(repository) {
    ...
    AdminComponent.prototype.loadProducts = function () {
        var _this = this;
        this.repository.getProducts().subscribe(function (data) { _this.products = data; }, function (error) { _this.error = error.message; console.log(error); });
    };
    ...
    AdminComponent.prototype.saveProduct = function () {
        ...
        if (this.isNewRecord) {
            this.products.pop();
            this.repository.createProduct(this.editedProduct).subscribe(function (data) {
            ...
            this.repository.updateProduct(this.editedProduct).subscribe(function (data) {
    ...
    AdminComponent.prototype.deleteProduct = function (product) {
        var _this = this;
        this.repository.deleteProduct(product.Id).subscribe(function (data) {
